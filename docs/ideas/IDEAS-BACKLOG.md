...
| [IDEA-030](IDEA-030-fix-critical-gaps.md) | Fix Critical Gaps — GitHub Actions + Test Coverage | v2.15 consistency review (synthesis) | 2026-04-09 | [REFINED] | fix | Major | v2.16 | 6 critical issues: GitHub Actions trigger wrong branch, no tests for critical paths (P0, XL) |
