...
| [IDEA-026](IDEA-026-session-lifecycle-automation.md) | Session Lifecycle Automation — Wire Heartbeat and Conversation Logging | Analysis gap (IDEA-019 exists but not automated) | 2026-04-08 | [REFINED] | dev-tooling | Minor | TBD | Wire checkpoint_heartbeat.py automation: VS Code task, session-end trigger, CI workflows |
