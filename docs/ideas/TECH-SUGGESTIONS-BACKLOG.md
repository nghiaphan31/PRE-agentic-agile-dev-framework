...
| TECH-004 | Master Traceability Tree — Enhanced Git Flow | 2026-04-08 | [ACCEPTED] | 8/10 | Extends ADR-006 with lab/, bugfix/, release/ branches; Refining workflow (lab→feature); Hot vs Cold fix separation; Release parallelism. **RE-REFINED 2026-04-08:** Branch types (lab/, bugfix/) and --no-ff accepted for v2.14. Release buffer and parallelism deferred. Naming convention deferred to TECH-005. |
| TECH-005 | Timebox-First Branch Naming Convention | 2026-04-08 | [ACCEPTED] | 3/10 | Corrected per Gemini: feature/{Timebox}/{IDEA-NNN}-{slug} — timebox grouping (2026-Q2, Sprint-42) instead of IDEA folder. Forward-compatible (existing branches don't need rename). |
