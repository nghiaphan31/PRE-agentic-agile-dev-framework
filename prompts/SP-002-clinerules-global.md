...
target_field: "Entire file â€” replace all content"
...
changelog:
  ...
  - version: 2.4.0
    ...
    change: "Added RULE 7 â€” large file generation chunking protocol"
  ...
  - version: 2.1.0
    ...
    change: "i18n â€” Full translation to English. All French prose translated; technical identifiers and commit format prefixes unchanged."
  ...
  - version: 2.0.0
    ...
    change: "Arbitration v2.0 â€” RULE 1 updated with explicit CHECK->CREATE->READ->ACT sequence (4 numbered steps). Replaces the former implicit formulation."
  ...
  - version: 1.0.0
    ...
    change: Initial creation â€” 6 rules (Memory Bank x4, Git, Prompt Consistency)
...
# SP-002 â€” Global Roo Code Directives (.clinerules)
...
```markdown
# PROTOCOL le workbench â€”â€ MANDATORY DIRECTIVES (ALL SESSIONS, ALL MODES)
...
1. CHECK : Does memory-bank/activeContext.md exist?
   ...
   - If NO Ã¢â€ â€™ proceed to the CREATE step



   - If YES Ã¢â€ â€™ proceed to the READ step
...
This CHECKÃ¢â€ â€™CREATEÃ¢â€ â€™READÃ¢â€ â€™ACT sequence is NON-NEGOTIABLE and applies to ALL sessions.
...
### 5.1 â€”â€ What MUST be versioned
...
### 5.3 â€”â€ Commit message format (Conventional Commits)
...
### 5.5 â€”â€ What must NOT be versioned
...
- .env files (API keys â€”â€ NEVER in Git)
...
### 6.1 â€”â€ Before any commit touching an artifact linked to a prompt
...
### 6.2 â€”â€ Verification procedure
...
### 6.3 â€”â€ Example commit with prompt update
...
## RULE 7: LARGE FILE GENERATION â€”â€ MANDATORY CHUNKING PROTOCOL
...
### 7.1 â€”â€ When this rule applies
...
### 7.3 â€”â€ Why this protocol is mandatory
...
> **Why CHECKÃ¢â€ â€™CREATEÃ¢â€ â€™READÃ¢â€ â€™ACT?** Without the prior check, the agent would attempt to read a non-existent file and fail silently. The sequence guarantees that the Memory Bank is always initialized before being read.
...
**Active mode:** [MODE]
**Active LLM backend:** MinMax M2.7 via OpenRouter (default) | Claude Sonnet API (fallback after 3 errors)
...
4. Roo Code re-reads `.clinerules` automatically at each new session â€” no additional action required
